...
const contactInfo = [
  {
    ...
    label: 'Phone Number',
    value: '+91 93454 83338',
    href: 'tel:+919345483338',
  },
  {
    icon: <Mail className="w-6 h-6" />,
    label: 'Email Address',
    value: 'info@tnce.ac.in',
    href: 'mailto:info@tnce.ac.in',
  },
  {
    icon: <MapPin className="w-6 h-6" />,
    label: 'Address',
    value: 'Karumathampatti, Coimbatore - 641659',
    href: '#',
  },
  {
    icon: <Globe className="w-6 h-6" />,
    label: 'Website',
    value: 'www.tnce.ac.in',
    href: 'https://www.tnce.ac.in',
  },
];
