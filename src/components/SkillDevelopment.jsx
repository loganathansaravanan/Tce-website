...
import ElectricianImg from '../assets/images/Electrician_Domestic.jpg';
  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        >
          <span className="inline-block text-accent font-semibold text-sm uppercase tracking-[0.25em] mb-4">
            Pradhan Mantri Kaushal Vikas Yojana
          </span>
          <h2 className="text-white text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 max-w-3xl mx-auto leading-tight">
            Skill Development Programs
          </h2>
          <p className="text-white/60 max-w-2xl mx-auto mb-8 text-base leading-relaxed">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 bg-accent hover:bg-accent-hover text-primary font-bold text-sm uppercase px-10 py-4 rounded-full tracking-wider transition-all duration-300 hover:shadow-xl hover:shadow-accent/25 hover:-translate-y-1"
          >
          ...
          {courses.map((course, i) => (
            ...
            >
              ...
              <div className="relative h-56 overflow-hidden">
                ...
                {/* Hours Badge */}
                <div className="absolute bottom-4 left-4 bg-accent text-primary font-bold text-xs uppercase px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg">
